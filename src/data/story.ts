export const eras = [
  ...
  {
    marker: '2013 – 2018',
    title: 'Immigration, Survival, and Adaptation',
    paras: [
      ...
      'In high school, I poured myself into academics, leadership, volunteering, and summer jobs because I understood that education was the clearest path forward. Eventually, that effort helped me earn the <span class="font-medium text-ink">Posse Foundation Full-Tuition Leadership Scholarship</span>, which opened the door to Wheaton College in Massachusetts. By then, my parents had regained enough stability to help support my housing costs, which was a major privilege and something I never took for granted.',
    ],
  },
  {
    marker: '2018 – 2022',
    title: 'Finding Astrobiology',
    paras: [
